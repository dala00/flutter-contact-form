...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "enterValidEmail":
            MessageLookupByLibrary.simpleMessage("正しいメルアドレスを入力してください。"),
        "fieldIsRequired": MessageLookupByLibrary.simpleMessage("入力してください"),
        "selectDate": MessageLookupByLibrary.simpleMessage("日付を選択"),
        "selectDateAndTime": MessageLookupByLibrary.simpleMessage("日時を選択"),
